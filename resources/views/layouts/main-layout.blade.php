                    ...
                    <div class="w-full md:w-1/2 lg:w-5/12 p-6">
                        <div class="flex flex-col justify-between h-full max-w-sm">
                            ...
                            <div>
                                ...
                                <p class="text-gray-400 text-sm">© Copyright 2022. All Rights Reserved by Gradia.</p>
                            </div>
                        </div>
                    </div>
                    <div class="w-full md:w-1/2 lg:w-2/12 p-6">
                        <div class="h-full">
                            <h3 class="mb-7 font-heading font-medium text-base text-gray-500 tracking-px">Company</h3>
                            <ul>
                                <li class="mb-4"><a class="font-heading font-medium text-base text-white hover:text-gray-200" href="#">Features</a></li>
                                <li class="mb-4"><a class="font-heading font-medium text-base text-white hover:text-gray-200" href="#">Pricing</a></li>
                                <li class="mb-4"><a class="font-heading font-medium text-base text-white hover:text-gray-200" href="#">Affiliate Program</a></li>
                                <li><a class="font-heading font-medium text-base text-white hover:text-gray-200" href="#">Press Kit</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="w-full md:w-1/2 lg:w-2/12 p-6">
                    ...
                    <div class="w-full md:w-1/2 lg:w-3/12 p-6">
                        <div class="flex flex-col justify-between h-full">
                            <div>
                                ...
                                <ul class="mb-6">
                                    <li class="mb-4 font-heading font-medium text-base text-white">hi@gradia.com</li>
                                    <li class="font-heading font-medium text-base text-white">+1 (394) 593 1994</li>
                                </ul>
                            </div>
